...
const translationKeys = ['common.save', 'common.cancel', 'common.delete', 'common.edit', 'common.loading', 'common.error', 'common.success', 'navigation.home', 'navigation.settings', 'navigation.profile', 'navigation.logout', 'app.title', 'app.language', 'app.welcome']
